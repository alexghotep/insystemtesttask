...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var tl4 = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
    scrollTrigger: {
      trigger: '.sc-steps__step_4',
      scrub: true,
      start: 'top bottom',
      end: 'top center'
    }
  });
  var tl5 = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
    scrollTrigger: {
      trigger: '.sc-steps__step_5',
      scrub: true,
      start: 'top bottom',
      end: 'top center'
    }
  });
  tl1.fromTo(".sc-steps__step_1", {
    opacity: 0,
    xPercent: -100
  }, {
    opacity: 1,
